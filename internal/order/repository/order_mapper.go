...
func ToDbOeHdr(ent *entities.ValidatedOrder) *prophet_19_1_3668.OeHdr {
	var oeHdrModel = &prophet_19_1_3668.OeHdr{
		OrderNo:       "",
		CustomerId:    0,
...
func FromDBPickTicket(dbPickTicket *prophet_19_1_3668.OePickTicket) (*entities.ValidatedPickTicket, error) {
...
func FromDBOrder(dbOrder *prophet_19_1_3668.OeHdr) (*entities.ValidatedOrder, error) {
