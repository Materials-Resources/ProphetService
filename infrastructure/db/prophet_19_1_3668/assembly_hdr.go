...
type AssemblyHdr struct {
	...
	Class1                       sql.NullString `bun:"class1,type:varchar(8),nullzero"`
	Class2                       sql.NullString `bun:"class2,type:varchar(8),nullzero"`
	Class3                       sql.NullString `bun:"class3,type:varchar(8),nullzero"`
	Class4                       sql.NullString `bun:"class4,type:varchar(8),nullzero"`
	Class5                       sql.NullString `bun:"class5,type:varchar(8),nullzero"`
