...
type InvMast struct {
	...
	ClassId1                      sql.NullString  `bun:"class_id1,type:varchar(8),nullzero"`
	ClassId2                      sql.NullString  `bun:"class_id2,type:varchar(8),nullzero"`
	ClassId3                      sql.NullString  `bun:"class_id3,type:varchar(8),nullzero"`
	ClassId4                      sql.NullString  `bun:"class_id4,type:varchar(8),nullzero"`
	ClassId5                      sql.NullString  `bun:"class_id5,type:varchar(8),nullzero"`
	...
	ItemSalesTaxClass             sql.NullString  `bun:"item_sales_tax_class,type:varchar(8),nullzero"`
