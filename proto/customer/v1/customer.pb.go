...
var file_customer_v1_customer_proto_rawDesc = []byte{
	...
	0x74, 0x75, 0x73, 0x32, 0x5d, 0x0a, 0x0f, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x4a, 0x0a, 0x09, 0x47, 0x65, 0x74, 0x4f, 0x72, 0x64,
	0x65, 0x72, 0x73, 0x12, 0x1d, 0x2e, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x2e, 0x76,
	0x31, 0x2e, 0x47, 0x65, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x1e, 0x2e, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x2e, 0x76, 0x31,
...
var file_customer_v1_customer_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_customer_v1_customer_proto_goTypes = []interface{}{
	...
	(*GetOrdersResponse_Order)(nil), // 2: customer.v1.GetOrdersResponse.Order
}
var file_customer_v1_customer_proto_depIdxs = []int32{
	2, // 0: customer.v1.GetOrdersResponse.orders:type_name -> customer.v1.GetOrdersResponse.Order
	0, // 1: customer.v1.CustomerService.GetOrders:input_type -> customer.v1.GetOrdersRequest
	1, // 2: customer.v1.CustomerService.GetOrders:output_type -> customer.v1.GetOrdersResponse
