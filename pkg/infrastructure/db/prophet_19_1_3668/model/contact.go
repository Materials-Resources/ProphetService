...
type Contact struct {
	...
	Class1id                  sql.NullString  `bun:"class_1id,type:varchar(8),nullzero"`
	Class2id                  sql.NullString  `bun:"class_2id,type:varchar(8),nullzero"`
	Class3id                  sql.NullString  `bun:"class_3id,type:varchar(8),nullzero"`
	Class4id                  sql.NullString  `bun:"class_4id,type:varchar(8),nullzero"`
	Class5id                  sql.NullString  `bun:"class_5id,type:varchar(8),nullzero"`
