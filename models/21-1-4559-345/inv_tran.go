...
type InvTran struct {
	...
	Period                 float64   `bun:"period,type:decimal(3,0),nullzero"`                         // Fiscal period associated with the change to quantity on-hand.
	YearForPeriod          float64   `bun:"year_for_period,type:decimal(4,0),nullzero"`                // Fiscal year associated with the change to quantity on-hand.
	...
	SubDocumentNo          float64   `bun:"sub_document_no,type:decimal(19,0),nullzero"`               // Used on a per transaction basis to provide additional transaction information.
	...
	LineNo                 float64   `bun:"line_no,type:decimal(19,0),nullzero"`                       // Line number associated with the originating transaction. ie. order line no
	...
	UsedSpecificCostFlag   string    `bun:"used_specific_cost_flag,type:char(1),nullzero"`             // column used to specify if special costing was used or not.
}
