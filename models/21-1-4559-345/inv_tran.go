...
type InvTran struct {
	...
	ReservedBeforeTrans    float64   `bun:"reserved_before_trans,type:decimal(19,9),default:(0)"`
	...
	SubDocumentNo          float64   `bun:"sub_document_no,type:decimal(19,0),nullzero"`
	...
	UsedSpecificCostFlag   string    `bun:"used_specific_cost_flag,type:char,nullzero"`
}
