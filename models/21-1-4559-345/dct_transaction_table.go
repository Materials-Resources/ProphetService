...
type DctTransactionTable struct {
	...
	LegacyFileSuffix       string    `bun:"legacy_file_suffix,type:varchar(255),nullzero"`                // code to identify legacy export file for this table
	BusinessObjectName     string    `bun:"business_object_name,type:varchar(255),nullzero"`              // business object that will handle validating and updating this table
	SetupEventName         string    `bun:"setup_event_name,type:varchar(255),nullzero"`                  // event to be called to setup business object
