...
type PriceLibrary struct {
	...
	SourcePriceCd                 int16     `bun:"source_price_cd,type:smallint,nullzero"`   // Code value for the Source Price if the Sales Pricing Library is of type Multiplier
	Multiplier                    float64   `bun:"multiplier,type:decimal(19,9),nullzero"`   // Multiplier value if the Sales Pricing Library is of type Multiplier
	...
	TerminalId                    float64   `bun:"terminal_id,type:decimal(19,0),nullzero"`                 // (Custom) The terminal ID used to retrieve this price for this item
	CompanyId                     string    `bun:"company_id,type:varchar(255),nullzero"`                   // Company that this library is for.
	...
	CustomerSizeCd                int32     `bun:"customer_size_cd,type:int,nullzero"`                      // Strategic Pricing Customer Size - Very Tiny, Tiny, Small, Medium, Large, or Huge
	CustomerCategoryUid           int32     `bun:"customer_category_uid,type:int,nullzero"`                 // Strategic Pricing Customer Category
	ExcludeFromCustMultiplierFlag string    `bun:"exclude_from_cust_multiplier_flag,type:char(1),nullzero"` // Indicate the new pricing multiplier in Customer Maintenance should NOT be applied against this library. Custom field.
}
