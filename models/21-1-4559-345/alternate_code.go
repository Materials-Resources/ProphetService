...
type AlternateCode struct {
	...
	AlternateCodeDesc  string    `bun:"alternate_code_desc,type:varchar(40),nullzero"`             // Description of the alternate code item
	...
	DefaultUom         string    `bun:"default_uom,type:varchar(8),nullzero"`                      // The default UOM to use when an item is entered using this record's alternate code
	ExcludeFromB2bFlag string    `bun:"exclude_from_b2b_flag,type:char(1),nullzero"`               // Determines if we should exclude this alternate code from the B2B DTS.
}
