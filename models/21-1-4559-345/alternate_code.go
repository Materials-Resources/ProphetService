...
type AlternateCode struct {
	...
	AlternateCodeDesc  string    `bun:"alternate_code_desc,type:varchar(40),nullzero"`
	...
	DefaultUom         string    `bun:"default_uom,type:varchar(8),nullzero"`
	ExcludeFromB2bFlag string    `bun:"exclude_from_b2b_flag,type:char,nullzero"`
}
