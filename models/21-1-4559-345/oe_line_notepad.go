...
type OeLineNotepad struct {
	...
	NotepadClassId   string    `bun:"notepad_class_id,type:varchar(8),nullzero"`                     // Class value for this note.
	...
	TallyNoteFlag    string    `bun:"tally_note_flag,type:char(1),nullzero"`                         // Custom, indicate if the note is for tally measurement for tally item.
}
