...
type Inventoryissuesresults64 struct {
	...
	SumTranLinesQtyAllocated float64 `bun:"sum_tran_lines_qty_allocated,type:decimal(38,9),nullzero"` // Total Qty Allocated (Transactions)
	TableInvLocQtyAllocated  float64 `bun:"table_inv_loc_qty_allocated,type:decimal(38,9),nullzero"`  // inv_loc.qty_allocated
}
