...
type ArReceipts struct {
	...
	GlBankAccountNo    string    `bun:"gl_bank_account_no,type:varchar(32),nullzero"`              // GL bank account number
	ArAccountNo        string    `bun:"ar_account_no,type:varchar(32),nullzero"`                   // What accouncts receivable account is this invoice to be credited to ?
	TermsAccountNo     string    `bun:"terms_account_no,type:varchar(32),nullzero"`                // The default account number to post terms discount for a new customer
	AllowedAccountNo   string    `bun:"allowed_account_no,type:varchar(32),nullzero"`              // Allowed account number
