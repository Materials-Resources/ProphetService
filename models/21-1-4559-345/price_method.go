...
type PriceMethod struct {
	...
	PricePagePrice `bun:"price_page_price,type:bit,default:((0))"`
	CustomerPrice  `bun:"customer_price,type:bit,default:((0))"`
	ContractPrice  `bun:"contract_price,type:bit,default:((0))"`
