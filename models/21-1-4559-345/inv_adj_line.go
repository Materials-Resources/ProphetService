...
type InvAdjLine struct {
	...
	QtyCountedFlag         string    `bun:"qty_counted_flag,type:char,nullzero"`
	...
	ParentTransLineNo      int32     `bun:"parent_trans_line_no,type:int,nullzero"`
	ActualPhysicalCountQty float64   `bun:"actual_physical_count_qty,type:decimal(19,9),default:((0))"`
	RecountFlag            string    `bun:"recount_flag,type:char,default:('N')"`
	TimesRecounted         int32     `bun:"times_recounted,type:int,default:((0))"`
