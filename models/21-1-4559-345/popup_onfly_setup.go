...
type PopupOnflySetup struct {
	...
	PopupOnflySetupUid int32     `bun:"popup_onfly_setup_uid,type:int,autoincrement,pk"`              // unic id of the table
	...
	AditionalColumn    string    `bun:"aditional_column,type:varchar(255),nullzero"`                  // Sql Definition  of the new column added
}
