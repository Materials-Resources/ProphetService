...
type SupplierPricing struct {
	...
	SourcePrice      string    `bun:"source_price,type:varchar(40),nullzero"`                        // When the pricing_method is Multiplier this indicates the base purchase price.
	Multiplier       float64   `bun:"multiplier,type:decimal(19,9),nullzero"`                        // When the pricing_method is Multiplier this indicates what to multiply the source_price by to get the purchase price.
