...
type XmlDocument struct {
	...
	RootElement           string    `bun:"root_element,type:varchar(255),nullzero"`            // Root element of xml document
	DocumentSectionPrefix string    `bun:"document_section_prefix,type:varchar(255),nullzero"` // Prefix for each TPCx xml document section
