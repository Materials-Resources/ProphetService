...
type ReversePaymentLine struct {
	...
	ShipToId              float64   `bun:"ship_to_id,type:decimal(19,0),nullzero"`                       // ShipToID for which the payment is reversed
	DepositNo             string    `bun:"deposit_no,type:varchar(40),nullzero"`                         // Deposit Number against which the amount is reversed
	...
	ReceiptNo             float64   `bun:"receipt_no,type:decimal(19,0),nullzero"`                       // Cash Receipts Receipt No that is being reversed
	PaymentNo             float64   `bun:"payment_no,type:decimal(19,0),nullzero"`                       // Cash Receipts Payment No that is being reversed
