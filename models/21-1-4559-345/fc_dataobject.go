...
type FcDataobject struct {
	...
	PrimaryDataobject string    `bun:"primary_dataobject,type:varchar(255),nullzero"`                // The dataobject for the primary datastore that shares data with the edited dataobject.
