...
type Division struct {
	...
	DivisionName              string    `bun:"division_name,type:varchar(255),nullzero"`                  // What is the name of this division?
	...
	DefaultCarrierId          float64   `bun:"default_carrier_id,type:decimal(19,0),nullzero"`           // Determines the default carrier for inventory returns for this division.
	DefaultFob                string    `bun:"default_fob,type:varchar(20),nullzero"`                    // Defaults the FOB setting for the inventory return.
	...
	DefaultAuthorizationNo    string    `bun:"default_authorization_no,type:varchar(255),nullzero"`      // Determines the default return authorization number for returns created for the division.
}
