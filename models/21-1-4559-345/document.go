...
type Document struct {
	...
	CustomerSend      int32     `bun:"customer_send,type:int,nullzero"`                           // Indicates if the document should be sent to ALL/SOME/NONE - code will be used
	DocumentDependent int32     `bun:"document_dependent,type:int,nullzero"`                      // Indicates if the document is dependent on the transaction, item or lot level
	...
	DocumentType      int32     `bun:"document_type,type:int,nullzero"`                           // Indicates the type of document (command line, Network, Word template) - selection affects the way the Path is defined
