...
type InvoiceLineAuditTrail struct {
	...
	InvoiceLineAuditTrailUid int32     `bun:"invoice_line_audit_trail_uid,type:int,identity"`
	...
	AuditUserName            `bun:"audit_user_name,type:nvarchar(256),nullzero"`
	AuditLoginName           `bun:"audit_login_name,type:nvarchar(256),nullzero"`
