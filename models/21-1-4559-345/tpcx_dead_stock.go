...
type TpcxDeadStock struct {
	...
	TpcxItemDesc          string    `bun:"tpcx_item_desc,type:varchar(255),nullzero"`                    // Selling Trading Partners description for the item.
	TpcxUpcCd             string    `bun:"tpcx_upc_cd,type:varchar(255),nullzero"`                       // UPC or EAC code for the item
