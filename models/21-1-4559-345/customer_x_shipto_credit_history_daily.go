...
type CustomerXShiptoCreditHistoryDaily struct {
	...
	CustomerXShiptoCdtHistoryDailyUid int32     `bun:"customer_x_shipto_cdt_history_daily_uid,type:int,pk,identity"`
	...
	InvoicedSales                     float64   `bun:"invoiced_sales,type:decimal(19,2)"`
	InvoicedCost                      float64   `bun:"invoiced_cost,type:decimal(19,4),nullzero"`
	InvoicedOtherCost                 float64   `bun:"invoiced_other_cost,type:decimal(19,4),default:((0))"`
	InvoicedCommissionCost            float64   `bun:"invoiced_commission_cost,type:decimal(19,4),default:((0))"`
