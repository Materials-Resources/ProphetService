...
type PurchaseCriteria struct {
	...
	RequirementTypeStock       bool      `bun:"requirement_type_stock,type:bit,default:(0)"`
	RequirementTypeNonStock    bool      `bun:"requirement_type_non_stock,type:bit,default:(0)"`
	RequirementTypeSpecial     bool      `bun:"requirement_type_special,type:bit,default:(0)"`
	RequirementTypeRequisition bool      `bun:"requirement_type_requisition,type:bit,default:(0)"`
	RequirementTypeDirectShip  bool      `bun:"requirement_type_direct_ship,type:bit,default:(0)"`
	RequirementTypeBackOrder   bool      `bun:"requirement_type_back_order,type:bit,default:(0)"`
