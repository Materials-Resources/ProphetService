...
type CashDrawerHistory struct {
	...
	ClosingBalance          float64   `bun:"closing_balance,type:decimal(19,4),nullzero"`               // Balance when drawer closed
	WithdrawTotal           float64   `bun:"withdraw_total,type:decimal(19,4),nullzero"`                // Total amount of money withdrawn from the drawer
	DepositTotal            float64   `bun:"deposit_total,type:decimal(19,4),nullzero"`                 // Total amount of money deposited to the drawer
	DepositNumber           string    `bun:"deposit_number,type:varchar(40),nullzero"`                  // Deposit number for payment -  applied when cash draw
	...
	DateClosed              time.Time `bun:"date_closed,type:datetime,nullzero"`                        // Date drawer is closed
	DateCreated             time.Time `bun:"date_created,type:datetime"`                                // Indicates the date/time this record was created.
	DateLastModified        time.Time `bun:"date_last_modified,type:datetime"`                          // Indicates the date/time this record was last modified.
	LastMaintainedBy        string    `bun:"last_maintained_by,type:varchar(30),default:(user_name())"` // ID of the user who last maintained this record
	TotalCashCardLoads      float64   `bun:"total_cash_card_loads,type:decimal(19,4),nullzero"`         // Amount of Cash Card transactions for a cash drawer once the drawer is closed.
}
