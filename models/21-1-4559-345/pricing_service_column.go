...
type PricingServiceColumn struct {
	...
	ColumnDesc              string    `bun:"column_desc,type:varchar(255),nullzero"`                        // Description of the column name
	AlternateColumnName     string    `bun:"alternate_column_name,type:varchar(40),nullzero"`               // Column name in other table
	InventoryDefaultsName   string    `bun:"inventory_defaults_name,type:varchar(40),nullzero"`             // Column name in the inventory (item) defaults table
	RequiredInd             string    `bun:"required_ind,type:char(1),nullzero"`                            // Indicates whether the column is required for a Build pricing service layout
	DefaultInd              string    `bun:"default_ind,type:char(1),nullzero"`                             // Indicates wehther the column default value is available in the item default table
	DeleteFlag              string    `bun:"delete_flag,type:char(1)"`                                      // Indicates whether this record is logically deleted
	DateCreated             time.Time `bun:"date_created,type:datetime"`                                    // Indicates the date/time this record was created.
	DateLastModified        time.Time `bun:"date_last_modified,type:datetime"`                              // Indicates the date/time this record was last modified.
	LastMaintainedBy        string    `bun:"last_maintained_by,type:varchar(30),default:(user_name(null))"` // ID of the user who last maintained this record
	DataType                string    `bun:"data_type,type:varchar(10),nullzero"`                           // Data type of the database column
	ColumnSize              float64   `bun:"column_size,type:decimal(19,0),nullzero"`                       // Size of the database column
	...
	TpcxAbbrevColumnName    string    `bun:"tpcx_abbrev_column_name,type:varchar(40),nullzero"`             // TPCx Abbreviated format column name
	TpcxAbbrevDate          time.Time `bun:"tpcx_abbrev_date,type:datetime,nullzero"`                       // Date sequence defined for TPCx abbreviated format
	...
	ActLayoutColumnName     string    `bun:"act_layout_column_name,type:varchar(40),nullzero"`              // Activant Pricing Service layout file's column name
	ActLayoutDate           time.Time `bun:"act_layout_date,type:datetime,nullzero"`                        // Activant Pricing Service layout date
	...
	AqnetLayoutColumnName   string    `bun:"aqnet_layout_column_name,type:varchar(40),nullzero"`            // Column name used by AQNet
	AqnetLayoutDate         time.Time `bun:"aqnet_layout_date,type:datetime,nullzero"`                      // Date the column_name was added to the support table
