...
type ItemLeadTime struct {
	...
	LocationId          float64   `bun:"location_id,type:decimal(19,0),nullzero"` // Location for which we are tracking lead time
	SupplierId          float64   `bun:"supplier_id,type:decimal(19,0),nullzero"` // Supplier for which we are tracking lead time
	...
	PoNo                float64   `bun:"po_no,type:decimal(19,0),nullzero"`                             // System-generated number assigned to a purchase order.
