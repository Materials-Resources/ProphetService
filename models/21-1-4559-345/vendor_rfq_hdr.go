...
type VendorRfqHdr struct {
	...
	Date840Sent      time.Time `bun:"date_840_sent,type:datetime,nullzero"`                         // Last Send of EDI 840 PO RFQ
	TypeCd           int32     `bun:"type_cd,type:int,nullzero"`                                    // Code to identify type of Vendor RFQ.
