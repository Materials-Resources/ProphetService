...
type PdaOelistCriteria struct {
	...
	TopXSearchOption      string    `bun:"top_x_search_option,type:char(1),nullzero"`          // Retrieving top x items by pieces sold or order lines.
	TopXCount             int32     `bun:"top_x_count,type:int,nullzero"`                      // Number of items to return for top X.
	InvoiceDays           int32     `bun:"invoice_days,type:int,nullzero"`                     // How many days in the past to look for invoices.
