...
type CommissionScheduleDetail struct {
	...
	CommissionScheduleDetailUid int32     `bun:"commission_schedule_detail_uid,type:int,autoincrement,unique"` // Identity column for commission_schedule_detail table.
}
