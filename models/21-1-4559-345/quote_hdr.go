...
type QuoteHdr struct {
	...
	Date843Sent      time.Time `bun:"date_843_sent,type:datetime,nullzero"`                          // Date when last EDI 843 was sent
	ExpirationDate   time.Time `bun:"expiration_date,type:datetime,nullzero"`                        // Date quote expires
}
