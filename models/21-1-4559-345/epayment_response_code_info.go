...
type EpaymentResponseCodeInfo struct {
	...
	EpymntResponseCodeInfoUid int32     `bun:"epymnt_response_code_info_uid,type:int,autoincrement,pk"`      // Unique identifier for the epayment_response_code_info table
