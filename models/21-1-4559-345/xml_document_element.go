...
type XmlDocumentElement struct {
	...
	ElementTypeCoded       string    `bun:"element_type_coded,type:varchar(255),nullzero"`      // Value of data within an element, of a named pair of elements.  The code identifies the meaning of the associated code value
	ValueElementName       string    `bun:"value_element_name,type:varchar(255),nullzero"`      // The name of the element which contains the value for a named value pair.
	ConvertedElementValue  string    `bun:"converted_element_value,type:varchar(255),nullzero"` // Conversion value for coded element.  1 is the converted_element_value when a CurrencyCoded element has the value USD
	...
	ListofNodeName         string    `bun:"listof_node_name,type:varchar(255),nullzero"`        // Name of the node element that indicates the subordinate element group is a repeating group
	...
	ValueId                float64   `bun:"value_id,type:decimal(19,0),nullzero"`               // Foreign key to pricing_service_value table, to allow translation of code to CC database value
	DateCreated            time.Time `bun:"date_created,type:datetime"`                         // Indicates the date/time this record was created.
	DateLastModified       time.Time `bun:"date_last_modified,type:datetime"`                   // Indicates the date/time this record was last modified.
	LastMaintainedBy       string    `bun:"last_maintained_by,type:varchar(30)"`                // ID of the user who last maintained this record
	ListofParentNodeName   string    `bun:"listof_parent_node_name,type:varchar(255),nullzero"` // Used with nested lists, the name of the node element that indicates the subordinate element group is a repeating group
}
