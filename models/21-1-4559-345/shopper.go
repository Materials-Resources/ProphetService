...
type Shopper struct {
	...
	DateLastLogon       time.Time `bun:"date_last_logon,type:datetime,nullzero"`                                                                                                                                                                                        // Date the shopper lasts logged on.
	DateLastLogoff      time.Time `bun:"date_last_logoff,type:datetime,nullzero"`                                                                                                                                                                                       // Date the shopper lasts logged off.
	AuthorizationTypeId int32     `bun:"authorization_type_id,type:int,nullzero"`                                                                                                                                                                                       // Whether the user has admin rights.
	...
	Random              int32     `bun:"random,type:int,nullzero"`                                                                                                                                                                                                      // unknown.
	DefaultShip2Id      float64   `bun:"default_ship2_id,type:decimal(19,0),nullzero"`                                                                                                                                                                                  // Default ship to id for the shopper/
}
