...
type Shopper struct {
	...
	WebShopperId        `bun:"web_shopper_id,type:nvarchar(128)"`
	WebLoginName        `bun:"web_login_name,type:nvarchar(128),default:('')"`
	WebLoginPassword    `bun:"web_login_password,type:nvarchar(128),default:('')"`
	WebLoginHint        `bun:"web_login_hint,type:nvarchar(128),default:('')"`
	WebEmail            `bun:"web_email,type:nvarchar(40),default:('')"`
	...
	LastMaintainedBy    `bun:"last_maintained_by,type:nvarchar(128),default:(user_name())"`
