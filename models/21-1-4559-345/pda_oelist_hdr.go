...
type PdaOelistHdr struct {
	...
	OelistListDescription string    `bun:"oelist_list_description,type:varchar(255),nullzero"` // Extended description of the list. Ex All the customers I go to every Monday.
